...
//
//        // подтягиваем корзину
//        CartEntity cart = this.cartService.findEntityByProfileId(orderDTO.getUserId());
//        if (cart == null || cart.getProductsInMarket().isEmpty()) {
...
//
//
//        for (ProductsInMarketEntity product : cart.getProductsInMarket()) {
//
